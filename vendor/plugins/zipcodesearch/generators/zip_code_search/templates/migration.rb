class <%= migration_name %> < ActiveRecord::Migration
  def self.up
     ...
     #zip_code_file = File.join(Rails.root, "db", "zip_codes.sql")
     ...
     require 'csv'
     zip_code_data = File.expand_path(File.join(Rails.root, 'vendor/plugins/zipcodesearch/generators/zip_code_search/templates/zip_code_data.csv'))
